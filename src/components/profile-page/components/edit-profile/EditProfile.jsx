...
const ProfileImageInput = ({ picture, handleRemovePicture, handleUploadPicture, working }) => (
  <div className="pictureFlex">
    <img src={picture || placeholder} alt="Profile" className="picture" />
    <button type="button" className="pictureFlexItem removePicture" onClick={handleRemovePicture}>
      Remove
    </button>
    <input
      type="file"
    ...
    />
    <span className="pictureFlexItem spinner">{working ? 'Uploading...' : null}</span>
  </div>
);
  ...
  <>
    <Form>
      ...
      <FormGroup>
        ...
        <Input type="textarea" id="interests" value={profile.interests} onChange={onEditChange} />
      </FormGroup>
      <FormGroup check>
        <Label check>
