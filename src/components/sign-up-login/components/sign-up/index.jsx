...
import FinishProfileModal from "components/sign-up-login/components/sign-up/finish-profile-modal";
...
class SignUp extends Component {
  ...
  onValueChange = ({ target: { id, checked, type, value } }) => {
    ...
    this.setState((prevState) => ({
      profile: { ...prevState.profile, [id]: value },
    }));
  };
    ...
    try {
      ...
      if (response) {
        ...
        await response.user.updateProfile({
          displayName: profile.full_name.replace(/ .*/, ""),
        });
        this.toggle();
      }
    } catch (error) {
