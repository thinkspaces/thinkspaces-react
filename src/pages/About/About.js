...
class About extends Component {
  ...
  componentDidMount = () => {
    unsubscribe = firebase.auth.onAuthStateChanged((authUser) => {
      this.setState({ isLoggedIn: !!authUser });
    });
  };
  ...
  render() {
    ...
    return (
      <BaseContainer displayLinks={isLoggedIn}>
        ...
        <Row>
          <Col md={{ size: 8, offset: 2 }}>
            <div>
              ...
              <br />
              <h3>
                We help you connect with the creatives and intellectuals who get things done, just
                like you. Expand beyond your network to build a better future with people who have
                different skills but the same vision.
              </h3>
              <br />
              <h3>
                Simply post whatever you are working on - creative passion project, startup, club
                project, anything - to find people to pursue your idea with you. Or get involved in
                a meaningful project from Thinkspaces, and do good things together.
              </h3>
            </div>
            <br />
